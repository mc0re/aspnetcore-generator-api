...
for hash in `ls /mnt/mycloud/Work/DockerRegistry/docker/registry/v2/repositories/$REPO/_manifests/revisions/sha256/ -t | tail -n +3`; do curl -X DELETE http://image-repo:55000/v2/$REPO/manifests/sha256:$hash; done
